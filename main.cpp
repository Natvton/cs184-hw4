...
#include <GL/glfw.h>  // Include FreeGLUT so we can easily draw spheres and calculate our viewing frustrum
...
void drawScene()
{
    ...
    glRotatef(earthRot * 5.0, 0.0f, 1.0f, 0.0f);
    ...
    glRotatef(moonRot * -10.0, 0.0f, 1.0f, 0.0f);
